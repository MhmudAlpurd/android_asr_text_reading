...
public class CameraSourcePreview extends ViewGroup {
  ...
  private void start(com.cogniteye.cogtrgoogleasr.CameraSource cameraSource) throws IOException {
  ...
  public void start(com.cogniteye.cogtrgoogleasr.CameraSource cameraSource, GraphicOverlay overlay) throws IOException {
  ...
  private void startIfReady() throws IOException, SecurityException {
    if (startRequested && surfaceAvailable) {
      ...
      if (overlay != null) {
        ...
        boolean isImageFlipped = cameraSource.getCameraFacing() == com.cogniteye.cogtrgoogleasr.CameraSource.CAMERA_FACING_FRONT;
        if (isPortraitMode()) {
